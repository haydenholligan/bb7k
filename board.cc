...
Board::Board() {
    ...
    propList[2] = Vector(-1, -1);
    propList[3] = Vector(57, 51);
    propList[4] = Vector(-1, -1);
    propList[5] = Vector(-1, -1);
    propList[6] = Vector(33, 51);
    propList[7] = Vector(-1, -1);
    propList[8] = Vector(17, 51);
    propList[9] =  Vector(9, 51);
    propList[10] = Vector(-1, -1);
    propList[11] = Vector(1, 46);
    propList[12] = Vector(-1, -1);
    propList[13] = Vector(1, 36);
    propList[14] = Vector(1, 31);
    propList[15] = Vector(-1, -1);
    propList[16] = Vector(1, 21);
    propList[17] = Vector(-1, -1);
    propList[18] = Vector(1, 11);
    propList[19] = Vector(1, 6);
    propList[20] = Vector(-1, -1);
    propList[21] = Vector(9, 1);
    propList[22] = Vector(-1, -1);
    propList[23] = Vector(25, 1);
    propList[24] = Vector(33, 1);
    propList[25] = Vector(-1, -1);
    propList[26] = Vector(49, 1);
    propList[27] = Vector(57, 1);
    propList[28] = Vector(-1, -1);
    propList[29] = Vector(73, 1);
    propList[30] = Vector(-1, -1);
    propList[31] = Vector(81, 6);
    propList[32] = Vector(81, 11);
    propList[33] = Vector(-1, -1);
    propList[34] = Vector(81, 21);
    propList[35] = Vector(-1, -1);
    propList[36] = Vector(-1, -1);
    propList[37] = Vector(81, 36);
    propList[38] = Vector(-1, -1);
    propList[39] = Vector(81, 46);
    
    coordList[0] = Vector(81, 54);
    coordList[1] = Vector(73, 54);
    coordList[2] = Vector(65, 54);
    coordList[3] = Vector(57, 54);
    coordList[4] = Vector(49, 54);
    coordList[5] = Vector(41, 54);
    coordList[6] = Vector(33, 54);
    coordList[7] = Vector(25, 54);
    coordList[8] = Vector(17, 54);
    coordList[9] =  Vector(9, 54);
    coordList[10] = Vector(1, 54);
    coordList[11] = Vector(1, 49);
    coordList[12] = Vector(1, 44);
    coordList[13] = Vector(1, 39);
    coordList[14] = Vector(1, 34);
    coordList[15] = Vector(1, 29);
    coordList[16] = Vector(1, 24);
    coordList[17] = Vector(1, 19);
    coordList[18] = Vector(1, 14);
    coordList[19] =  Vector(1, 9);
    coordList[20] =  Vector(1, 4);
    coordList[21] =  Vector(9, 4);
    coordList[22] =  Vector(17, 4);
    coordList[23] =  Vector(25, 4);
    coordList[24] =  Vector(33, 4);
    coordList[25] =  Vector(41, 4);
    coordList[26] =  Vector(49, 4);
    coordList[27] =  Vector(57, 4);
    coordList[28] =  Vector(65, 4);
    coordList[29] =  Vector(73, 4);
    coordList[30] =  Vector(81, 4);
    coordList[31] =  Vector(81, 9);
    coordList[32] =  Vector(81, 14);
    coordList[33] =  Vector(81, 19);
    coordList[34] =  Vector(81, 24);
    coordList[35] =  Vector(81, 29);
    coordList[36] =  Vector(81, 34);
    coordList[37] =  Vector(81, 44);
    coordList[38] =  Vector(81, 49);
    coordList[39] =  Vector(81, 54);
